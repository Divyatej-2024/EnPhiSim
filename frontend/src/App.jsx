...
import L7 from "./pages/levels/adv_easy/l7";
import L8 from "./pages/levels/adv_easy/l8";
import L9 from "./pages/levels/adv_easy/l9";
import L10 from "./pages/levels/adv_easy/l10";
import L11 from "./pages/levels/adv_easy/l11";
import L12 from "./pages/levels/adv_easy/l12";
...
// Pre-hard levels
import L19 from "./pages/levels/pre_hard/l19";
import L20 from "./pages/levels/pre_hard/l20";
import L21 from "./pages/levels/pre_hard/l21";
import L22 from "./pages/levels/pre_hard/l22";
import L23 from "./pages/levels/pre_hard/l23";
...
import L29 from "./pages/levels/adv_hard/l29";
import L30 from "./pages/levels/adv_hard/l30";
import L31 from "./pages/levels/adv_hard/l31";
import L32 from "./pages/levels/adv_hard/l32";
// Bonus
import BL1 from "./pages/levels/bonus_levels/bl1";
import BL2 from "./pages/levels/bonus_levels/bl2";
import BL3 from "./pages/levels/bonus_levels/bl3";
import BL4 from "./pages/levels/bonus_levels/bl4";
import BL5 from "./pages/levels/bonus_levels/bl5";
import BL6 from "./pages/levels/bonus_levels/bl6";
