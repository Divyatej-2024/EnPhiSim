...
export default function Disclaimer() {
  ...
  return (
    <div style={{
      ...
      <div style={{ background: "#071029", padding: 28, borderRadius: 12, maxWidth: 800, textAlign: "left" }}>
        ...
        <label style={{ display: "flex", gap: 10, alignItems: "center", marginTop: 16 }}>
          ...
          <span>I confirm I have read and agree to participate in this simulation.</span>
        </label>
        ...
        <div style={{ marginTop: 18, display: "flex", gap: 8 }}>
          <button onClick={() => {
            ...
            navigate("/dashboard");
          }} style={{ padding: "8px 12px", background: "#2563eb", color: "#fff", borderRadius: 8, border: "none" }}>
            Proceed to Dashboard
          </button>

          <button onClick={() => {
            // optional: clear any previous data
            if (confirm("Clear local simulation data?")) {
              localStorage.removeItem("enphisim_actions");
              alert("Local data cleared.");
            }
          }} style={{ padding: "8px 12px", background: "#0b1220", color: "#cbd5e1", borderRadius: 8, border: "1px solid #1f2937" }}>
            Clear Local Data
          </button>
        </div>
      </div>
