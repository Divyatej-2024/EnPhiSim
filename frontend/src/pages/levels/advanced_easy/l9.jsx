...
/**
 * Auto-generated component for l9 — Malicious survey /feedback request
 * Hint: Survey asks for sensitive personal or security questions.
 * from_to: malicious feedback survey request to user
 */

export default function L_l9() {
  ...
  const handleChoice = (key) => {
    ...
    setTimeout(() => {
      navigate("/levels/advanced easy/l10");
    }, 900);
  };
  ...
  return (
    <div className="level-container fade-in">
      ...
      <h1>Malicious survey /feedback request — Survey asks for sensitive personal or security questions.</h1>
      <p className="level-subtitle"></p>

      <div className="email-wrapper">
        <div className="task-box">
          <h3>Your Task:</h3>
          <p>Survey asks for sensitive personal or security questions.</p>
        </div>
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <span className="sender-hover">
              malicious feedback survey request to user
            ...
            <h3 className="email-subject">Malicious survey /feedback request</h3>
          </div>
