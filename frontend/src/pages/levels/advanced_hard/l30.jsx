...
/**
 * Auto-generated component for l30 — Homograph/unicode confusablle domain attacks
 * Hint: Characters look identical but are different.
 * from_to: fake domain similar as the real domain
 */

export default function L_l30() {
  ...
  const handleChoice = (key) => {
    ...
    setTimeout(() => {
      navigate("/levels/advanced hard/l31");
    }, 900);
  };
  ...
  return (
    <div className="level-container fade-in">
      ...
      <h1>Homograph/unicode confusablle domain attacks — Characters look identical but are different.</h1>
      <p className="level-subtitle"></p>

      <div className="email-wrapper">
        <div className="task-box">
          <h3>Your Task:</h3>
          <p>Characters look identical but are different.</p>
        </div>
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <span className="sender-hover">
              fake domain similar as the real domain
            ...
            <h3 className="email-subject">Homograph/unicode confusablle domain attacks</h3>
          </div>
