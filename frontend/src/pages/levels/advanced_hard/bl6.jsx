...
/**
 * Auto-generated component for bl6 — HoneyBee
 * Hint: 
 * from_to: Facts of honeybee and Technology
 */

export default function L_bl6() {
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <span className="sender-hover">
              Facts of honeybee and Technology
            ...
            <h3 className="email-subject">HoneyBee</h3>
          </div>
