...
/**
 * Auto-generated component for bl1 — Eagle
 * Hint: 
 * from_to: Facts of eagle and Technology
 */

export default function L_bl1() {
  ...
  const handleChoice = (key) => {
    ...
    setTimeout(() => {
      navigate("/levels/advanced easy/l7");
    }, 900);
  };
      ...
      <div className="email-wrapper">
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <h3 className="email-subject">Eagle</h3>
          </div>
