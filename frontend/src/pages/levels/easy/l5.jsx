...
/**
 * Auto-generated component for l5 — Simple attachment Lure
 * Hint: Unexpected or suspicious file type
 * from_to: fake HR to reciever
 */

export default function L_l5() {
  ...
  return (
    <div className="level-container fade-in">
      ...
      <h1>Simple attachment Lure — Unexpected or suspicious file type</h1>
      <p className="level-subtitle"></p>

      <div className="email-wrapper">
        <div className="task-box">
          <h3>Your Task:</h3>
          <p>Unexpected or suspicious file type</p>
        </div>
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <h3 className="email-subject">Simple attachment Lure</h3>
          </div>
