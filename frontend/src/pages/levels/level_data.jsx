...
const levels = [
  // EASY
  { id: "l1", title: "Master Credential-Phish", category: "easy",
    content: "<p>Your account verification has timed out. Please re-verify your account immediately to avoid suspension.</p>",
    options: [
      { id: "verify", label: "Verify Now (Click link)" },
      { id: "remind", label: "Remind Me Later" },
      { id: "unsubscribe", label: "Unsubscribe" }
    ],
    correctOption: "unsubscribe",
    hints: ["Look at the sender address and link domain", "Legitimate services rarely ask to verify via an unexpected link"],
    nextLevel: "l2",
    points: 100
  },

  { id: "l2", title: "Scam Invoice / Payment Reminder", category: "easy",
    content: "<p>Invoice attached: Please download the attached invoice to confirm payment.</p>",
    options: [
      { id: "download", label: "Download Attachment" },
      { id: "report", label: "Report as Phishing" },
      { id: "reply", label: "Reply to Sender" }
    ],
    correctOption: "report",
    hints: ["Attachments from unknown senders can contain malware", "Check the sender domain and invoice details"],
    nextLevel: "l3",
    points: 100
  },

  // ... Continue entries for every level ...
  // For brevity, I'll include the rest with minimal fields.
  { id: "l3", title: "Fake Newsletter Subscription", category: "easy",
    content: "<p>Confirm your newsletter subscription by clicking below.</p>",
    options: [{id:"confirm",label:"Confirm"},{id:"ignore",label:"Ignore"},{id:"report",label:"Report"}],
    correctOption: "report",
    hints:["Unexpected subscribes are suspicious"], nextLevel:"l4", points:80
  },
  { id: "l4", title: "Lottery / Prize Scam", category: "easy",
    content: "<p>You have won! Claim your prize by providing your bank details.</p>",
    options: [{id:"claim",label:"Claim Prize"},{id:"report",label:"Report"},{id:"delete",label:"Delete"}],
    correctOption: "report",
    hints:["Never provide bank details to claim a prize"], nextLevel:"l5", points:120
  },
  { id: "l5", title: "Simple Attachment Lure", category: "easy",
    content: "<p>See attached document with details about your order.</p>",
    options: [{id:"open",label:"Open Attachment"},{id:"save",label:"Save"} ,{id:"report",label:"Report"}],
    correctOption: "report",
    hints:["Attachments from unknown sources are risky"], nextLevel:"l6", points:90
  },
  { id: "l6", title: "Basic Spoofed Display-Name Sender", category: "easy",
    content: "<p>Message appears from HR but uses a public gmail address.</p>",
    options: [{id:"trust",label:"Trust & Reply"},{id:"verify",label:"Verify Sender"},{id:"report",label:"Report"}],
    correctOption: "verify",
    hints:["Display name may be spoofed; check full email address"], nextLevel:"bl1", points:110
  },
  { id: "bl1", title: "Eagle (Bonus)", category: "easy_bonus",
    content: "<p>Bonus: a mixed bag of obvious tricks. Identify them fast.</p>",
    options: [{id:"flag",label:"Flag all suspicious items"},{id:"ignore",label:"Ignore"}],
    correctOption: "flag",
