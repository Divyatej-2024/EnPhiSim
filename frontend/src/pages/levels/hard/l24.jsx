...
/**
 * Auto-generated component for l24 — Business Process Commpromise
...
export default function L_l24() {
  ...
  return (
    <div className="level-container fade-in">
      ...
      <h1>Business Process Commpromise — Unexpected changes to internal systems or processes that don't match formal approvals.</h1>
      <p className="level-subtitle"></p>

      <div className="email-wrapper">
        <div className="task-box">
          <h3>Your Task:</h3>
          <p>Unexpected changes to internal systems or processes that don't match formal approvals.</p>
        </div>
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <h3 className="email-subject">Business Process Commpromise</h3>
          </div>
