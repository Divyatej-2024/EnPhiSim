...
/**
 * Auto-generated component for l27 — man-in-the-middle credential capture
 * Hint: The login page has a valid URL but asks for credentials too often.
 * from_to: Fake captur to reciever
 */

export default function L_l27() {
  ...
  return (
    <div className="level-container fade-in">
      ...
      <h1>man-in-the-middle credential capture — The login page has a valid URL but asks for credentials too often.</h1>
      <p className="level-subtitle"></p>

      <div className="email-wrapper">
        <div className="task-box">
          <h3>Your Task:</h3>
          <p>The login page has a valid URL but asks for credentials too often.</p>
        </div>
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <h3 className="email-subject">man-in-the-middle credential capture</h3>
          </div>
