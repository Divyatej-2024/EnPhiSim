...
/**
 * Auto-generated component for l7 — TypoSquatted Domain Phish
 * Hint: Check the full email address, not just the name.
 * from_to: Fake domain to the user
 */

export default function L_l7() {
  ...
  const handleChoice = (key) => {
    ...
    setTimeout(() => {
      navigate("/levels/advanced easy/l8");
    }, 900);
  };
  ...
  return (
    <div className="level-container fade-in">
      ...
      <h1>TypoSquatted Domain Phish — Check the full email address, not just the name.</h1>
      <p className="level-subtitle"></p>

      <div className="email-wrapper">
        <div className="task-box">
          <h3>Your Task:</h3>
          <p>Check the full email address, not just the name.</p>
        </div>
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <h3 className="email-subject">TypoSquatted Domain Phish</h3>
          </div>
