...
/**
 * Auto-generated component for bl3 — Turtle
 * Hint: 
 * from_to: Facts of turtle and Technology
 */

export default function L_bl3() {
        ...
        <div className="email-panel">
          ...
          <div className="email-header">
            ...
            <span className="sender-hover">
              Facts of turtle and Technology
            ...
            <h3 className="email-subject">Turtle</h3>
          </div>
